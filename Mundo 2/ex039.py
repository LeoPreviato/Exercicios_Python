...
sexo = str(input("Agora digite o seu sexo [M/F]: ")).strip().upper()[:1]

# Se o sexo da pessoa for masculino, ele vai executar todo o código
if sexo == "M":
...
# Se for mulher o código não será executado
else:
    print("Você é uma mulher e portanto não precisa fazer o alistamento")